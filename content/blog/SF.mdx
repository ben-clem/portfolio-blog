...
<p align="center" style={{ textDecoration: "underline" }}>
  Myself removing the excess metal after my amateur arc welding
</p>

The mirror that is fixed on top was bought in a reusable materials organization. The styrofoam heads, the paint, the individually addressable LED strips, the Arduino board, and the power supply and cables were purchased on Amazon. The gold head crown is 3D printed.
