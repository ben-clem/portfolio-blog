...
I then worked as a **Web & Mobile Developer** at [IDEMIA](https://en.wikipedia.org/wiki/IDEMIA) for 5 months, during which I developed a fleet monitoring web app in **JavaScript** with **React**, which I then integrated into an **Android** mobile app.\
